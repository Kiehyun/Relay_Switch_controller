#include <Arduino.h>
#line 1 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
...
//  │  D7     │  IN      │  버튼 RIGHT (INPUT_PULLUP)                                   │
//  │  D8     │  IN      │  버튼 UP    (INPUT_PULLUP)                                   │
//  │  D9     │  IN      │  버튼 DOWN  (INPUT_PULLUP)                                   │
//  │  D10    │  IN      │  버튼 LEFT  (INPUT_PULLUP)                                   │
//  │  A4     │  I2C SDA │  OLED SSD1306 데이터 (I2C)                                  │
//  │  A5     │  I2C SCL │  OLED SSD1306 클록  (I2C)                                   │
//  │  D3     │  OUT     │  릴레이 채널 1 — 미사용 (고장)                              │
//  │  D4     │  OUT     │  릴레이 채널 2 — c/C (500ms 펄스 또는 메뉴 ON/OFF)           │
//  │  D5     │  OUT     │  릴레이 채널 3 — o/O (500ms 펄스 또는 메뉴 ON/OFF)           │
...
//  'r'       : CH4 ON   - 채널 4 릴레이 ON
//  'f'       : CH4 OFF  - 채널 4 릴레이 OFF
...
short menu = 1; // 현재 선택된 메뉴 항목 (1=CH4, 2=CH2, 3=CH3)

// ----------------------------------------------------------------------------------------------------------
// 릴레이 핀 정의 및 상태 변수
// ----------------------------------------------------------------------------------------------------------
#define RELAY_CLOSE 4  // D4 — CH2 (c/C, 시리얼 또는 메뉴에서 ON/OFF)
#define RELAY_OPEN  5  // D5 — CH3 (o/O, 시리얼 또는 메뉴에서 ON/OFF)
...
// ----------------------------------------------------------------------------------------------------------
#line 166 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void setup();
#line 197 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void loop();
#line 211 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void doClose();
#line 223 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void doOpen();
#line 245 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void serialCommand(char _command);
#line 280 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void serialEvent();
#line 296 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void humidityTemperatureReport();
#line 336 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void controljudge();
#line 356 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void pinset();
#line 364 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void relayMenuControl();
#line 432 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void buttonRead();
#line 474 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void U8G_start();
#line 481 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
int centerXForText(const char *text);
#line 492 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void U8G_test();
#line 513 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void U8G_draw();
#line 166 "C:\\Users\\Kiehyun\\Desktop\\KBox\\Github\\Relay_Switch_controller\\mp4dome_4chOLED\\mp4dome_4chOLED.ino"
void setup() 
  {
...
//   - 시리얼 버퍼에 데이터가 있으면 1바이트씩 읽어 단일 문자 명령으로 처리
//   - 개행문자('\n', '\r')는 무시
// ----------------------------------------------------------------------------------------------------------
void serialEvent() 
  {
          ...
          if (S[0])
            {
              digitalWrite(RELAY_CLOSE, HIGH);
              relayStatus2 = 1;
              lastRelayMessage = "CH2 ON";
              lastRelayTime = millis();
              Serial.println(F("CH2:ON#"));
            }
          else if (S[1])
            {
              digitalWrite(RELAY_CLOSE, LOW);
              relayStatus2 = 0;
              lastRelayMessage = "CH2 OFF";
              lastRelayTime = millis();
              Serial.println(F("CH2:OFF#"));
            }
          break;
          ...
          if (S[0])
            {
              ...
              relayStatus3 = 1;
              lastRelayMessage = "CH3 ON";
              lastRelayTime = millis();
              Serial.println(F("CH3:ON#"));
            }
          else if (S[1])
            {
              digitalWrite(RELAY_OPEN, LOW);
              relayStatus3 = 0;
              lastRelayMessage = "CH3 OFF";
              lastRelayTime = millis();
              Serial.println(F("CH3:OFF#"));
            }
          break;
      }
        ...
        switch (subm)
          {
            case 0:
              u8g.setFont(u8g_font_6x10);
              u8g.setFontPosTop();
              u8g.drawStr(30, 14, "STATUS");

              u8g.setFontPosTop();
              u8g.drawStr(0, 28, "CH4:");
              u8g.drawStr(28, 28, relayStatus4 ? "ON " : "OFF");
              u8g.drawStr(70, 28, "CH2:");
              u8g.drawStr(102, 28, relayStatus2 ? "ON " : "OFF");
              u8g.drawStr(0, 40, "CH3:");
              u8g.drawStr(28, 40, relayStatus3 ? "ON " : "OFF");
              u8g.drawStr(70, 40, "CH1:");
              u8g.drawStr(102, 40, "N/A");
            ...
            case 1:
              ...
              u8g.drawStr(12, 32, "1. CH4 ON/OFF");
              u8g.drawStr(12, 40, "2. CH2 ON/OFF");
              u8g.drawStr(12, 48, "3. CH3 ON/OFF");
              ...
              switch (menu)
                {
                  ...
                  case 2:
                    u8g.drawStr(20, 14, "CH2 CTRL");
                    u8g.setFont(u8g_font_6x10);
                    u8g.drawStr(0, 32, "State:");
                    u8g.drawStr(40, 32, relayStatus2 ? "ON " : "OFF");
                    u8g.drawStr(0, 44, "UP:ON DN:OFF");
                    u8g.drawStr(0, 54, "LEFT: Back");
                    break;

                  case 3:
                    u8g.drawStr(20, 14, "CH3 CTRL");
                    u8g.setFont(u8g_font_6x10);
                    u8g.drawStr(0, 32, "State:");
                    u8g.drawStr(40, 32, relayStatus3 ? "ON " : "OFF");
                    u8g.drawStr(0, 44, "UP:ON DN:OFF");
                    u8g.drawStr(0, 54, "LEFT: Back");
                    break;
                }
        ...
        if (lastRelayMessage && (millis() - lastRelayTime) < RELAY_MSG_DURATION)
          {
            ...
            u8g.setColorIndex(0);
            u8g.drawStr(30, 48, lastRelayMessage);
            u8g.setColorIndex(1);
          }
      }
    while (u8g.nextPage());
